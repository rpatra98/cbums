...
export default async function CompanyDetailPage({ params }: { params: { id: string | Promise<string> } }) {
  // Handle both string and Promise cases for backwards compatibility
  const companyId = typeof params.id === 'string' ? params.id : React.use(params.id);
